...
- Diferença para EX1: pretrained=False (R3D_18 inicializado sem pesos Kinetics-400).
- Mantém: AMP, multi-GPU, oversampling e augmentation baseline (para comparação justa).
"""
