...
if __name__ == "__main__":
    ...
    cfg = ExperimentConfig(
        ...
        multi_gpu=True, 
        gpu_ids=(0, 1),   # Ajusta a lista de GPUs para bater com multi_gpu=False (evita o código tentar referenciar 2 GPUs e mantém a configuração consistente/sem ambiguidade).
